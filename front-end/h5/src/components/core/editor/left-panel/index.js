  ...
  render(h) {
    return (
      <a-layout-sider
        width="300"
        theme="light"
        style={{ background: '#fff', padding: '12px', paddingLeft: 0 }}
      >
        <a-tabs style="height: 100%;" tabBarGutter={10} tabPosition="left">
          <a-tab-pane
            key="plugin-list"
            tab={this.$t('editor.sidebar.components')}
          >
            <RenderShortcutsPanel elementManager={this.elementManager} />
          </a-tab-pane>
          ...
          <a-tab-pane
            key="preferences"
            tab={this.$t('editor.sidebar.preferences')}
          >
